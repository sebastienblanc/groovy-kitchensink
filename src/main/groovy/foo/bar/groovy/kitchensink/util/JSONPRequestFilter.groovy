 ...
 */
package foo.bar.groovy.kitchensink.util
 ...
 */
@WebFilter("/rest/*")
class JSONPRequestFilter implements Filter {
    ...
    private static def SAFE_PRN = ~/[a-zA-Z0-9_\\.]+/
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
        ...
        if (!isJSONPRequest(callback)) {
            ...
            if (!(callback ==~ SAFE_PRN)) {//TODO do it in a groovy way
                throw new ServletException("JSONP Callback method '${CALLBACK_METHOD}' parameter not a valid function")
            }
